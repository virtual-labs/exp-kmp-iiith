...
const myQuestions = [{
question: "1. Which of these best describes a substring?", ///// Write the question inside double quotes
answers: {
a: "A contiguous sequence of characters within a string in any order ", ///// Write the option 1 inside double quotes
b: "Contiguous sequence of characters within a string in the same order", ///// Write the option 2 inside double quotes
c: "Any combination of a subset of characters from a string in any order.", ///// Write the option 2 inside double quotes
d: "Any combination of a subset of characters from a string in the same order as the string.", ///// Write the option 2 inside double quotes
},
...
c: "TI", ///// Write the option 3 inside double quotes
d: "TIK ", ///// Write the option 4 inside double quotes
},
